    ...
    <aside className='w-full'>
      ...
      <div className='mb-8'>
        ...
        <p className='mt-4 text-sm font-medium'>
          Giá: {localPriceRange.min.toLocaleString()}đ -{' '}
          {localPriceRange.max.toLocaleString()}đ
        </p>
        <Button
          variant='primary'
          //   size="sm"
      ...
      {/* Brands */}
      <div className='mb-8'>
        <h3 className='text-lg font-semibold mb-4'>Lọc theo thương hiệu</h3>
        <ul className='space-y-3'>
          {brands.map((brand) => (
      ...
      {/* Tags */}
      <div>
        <h3 className='text-lg font-semibold mb-4'>Lọc theo thẻ</h3>
          ...
          {tags.map((tag) => (
            <button
              ...
              className={`py-2 px-4 rounded-xl text-sm font-semibold ${
                tag.selected
                  ? 'bg-gray-50 text-[#fd7e14] border border-orange-DEFAULT'
