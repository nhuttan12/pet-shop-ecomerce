    ...
    <header className="bg-white">
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm font-medium">+379 871-8371</span>
            </div>
      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center shadow-md rounded-[40px] bg-white">
        <div className="flex items-center">
          ...
          />
          <span className="ml-2 text-lg font-bold">NLU Pet Shop</span>
        </div>
          ...
          {isLoggedIn ? (
            <div className="flex items-center space-x-3">
              <button
                ...
                className="flex items-center text-sm font-medium text-black hover:text-[#fd7e14]"
              >
              ...
              <button
                onClick={logout}
                className="text-sm font-medium text-black hover:text-[#fd7e14]"
              >
                Đăng xuất
              </button>
            </div>
            ...
            <button
              ...
              className="text-lg font-medium text-black hover:text-[#fd7e14] cursor-pointer"
            >
              Đăng nhập
            </button>
          )}
